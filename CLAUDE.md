...
| [docs/writing-blocks.md](docs/writing-blocks.md)                     | The `writing` fence — text the agent wrote for you to copy, the card renderer, and the instruction every provider gets         |
