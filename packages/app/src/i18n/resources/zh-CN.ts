  ...
  workspace: {
    ...
    tabs: {
      ...
      menu: {
        ...
        copyChatMarkdown: "复制聊天记录 (Markdown)",
        copyChatJson: "复制聊天记录 (JSON)",
      ...
      toasts: {
        ...
        chatCopiedLabel: "聊天记录",
        copyingChat: "正在复制聊天记录...",
        copyChatFailed: "复制聊天记录失败",
        chatCopyEmpty: "此聊天为空",
        chatCopyTruncated: "已复制聊天记录，但不包含最早的消息",
    ...
    git: {
      ...
      pr: {
        ...
        set: {
          ...
          attachPlaceholder: "PR 编号，例如 1346 或 1346, 1350",
          attachConfirm: "Attach",
          attachNotFound: "No pull request #{{number}} found in this repository.",
          attachNotFoundMany: "在此仓库中找不到拉取请求：{{numbers}}",
          moreInCard: "还有 {{count}} 个",
