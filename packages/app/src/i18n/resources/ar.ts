  ...
  workspace: {
    ...
    browser: {
      ...
      activity: {
        ...
        checkingPage: "جارٍ فحص الصفحة",
        recheckPage: "إعادة فحص الصفحة",
        paused: "متوقف مؤقتًا · أنت تتحكم",
        pausing: "سيتم التولي بعد هذه الخطوة",
        passed: "نجح التشغيل",
        failed: "فشل التشغيل · {{message}}",
        takeOver: "تولَّ التحكم",
        resume: "استئناف",
        dismiss: "إخفاء حالة تشغيل المتصفح",
        openSteps: "يفتح نظرة عامة على الخطوات",
        now: "الآن",
        next: "التالي",
        steps: "الخطوات",
    ...
    tabs: {
      ...
      menu: {
        ...
        copyChatMarkdown: "نسخ المحادثة (Markdown)",
        copyChatJson: "نسخ المحادثة (JSON)",
      ...
      toasts: {
        ...
        chatCopiedLabel: "نص المحادثة",
        copyingChat: "جارٍ نسخ المحادثة...",
        copyChatFailed: "تعذر نسخ المحادثة",
        chatCopyEmpty: "هذه المحادثة فارغة",
        chatCopyTruncated: "تم نسخ المحادثة بدون أقدم الرسائل",
    ...
    git: {
      ...
      pr: {
        ...
        set: {
          ...
          attachPlaceholder: "أرقام طلبات السحب، مثل 1346 أو 1346, 1350",
          attachConfirm: "Attach",
          attachNotFound: "No pull request #{{number}} found in this repository.",
          attachNotFoundMany: "لم يتم العثور على طلبات سحب في هذا المستودع: {{numbers}}",
          moreInCard: "+{{count}} أخرى",
