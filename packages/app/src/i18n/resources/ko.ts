  ...
  workspace: {
    ...
    browser: {
      ...
      activity: {
        ...
        checkingPage: "페이지 확인 중",
        recheckPage: "페이지 다시 확인",
        paused: "일시 중지됨 · 직접 제어 중",
        pausing: "이 단계 후 제어를 넘겨받습니다",
        passed: "실행 성공",
        failed: "실행 실패 · {{message}}",
        takeOver: "제어 넘겨받기",
        resume: "재개",
        dismiss: "브라우저 실행 상태 닫기",
        openSteps: "단계 개요를 엽니다",
        now: "현재",
        next: "다음",
        steps: "단계",
        noSteps: "아직 단계가 없습니다",
    ...
    tabs: {
      ...
      menu: {
        ...
        copyChatMarkdown: "채팅 복사 (Markdown)",
        copyChatJson: "채팅 복사 (JSON)",
      ...
      toasts: {
        ...
        chatCopiedLabel: "채팅 기록",
        copyingChat: "채팅을 복사하는 중...",
        copyChatFailed: "채팅을 복사하지 못했습니다",
        chatCopyEmpty: "이 채팅은 비어 있습니다",
        chatCopyTruncated: "가장 오래된 메시지를 제외하고 채팅을 복사했습니다",
    ...
    git: {
      ...
      pr: {
        ...
        set: {
          ...
          attachPlaceholder: "PR 번호, 예: 1346 또는 1346, 1350",
          attachConfirm: "Attach",
          attachNotFound: "No pull request #{{number}} found in this repository.",
          attachNotFoundMany: "이 저장소에서 풀 리퀘스트를 찾을 수 없습니다: {{numbers}}",
          moreInCard: "외 {{count}}개",
