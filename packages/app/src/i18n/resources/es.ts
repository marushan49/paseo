  ...
  workspace: {
    ...
    browser: {
      ...
      activity: {
        ...
        step: "Paso {{step}}",
        stepOf: "Paso {{step}}/{{total}}",
        checkingPage: "Revisando la página",
        recheckPage: "Volver a revisar la página",
        paused: "En pausa · tienes el control",
        pausing: "Tomando el control tras este paso",
        passed: "Ejecución superada",
        failed: "Ejecución fallida · {{message}}",
        takeOver: "Tomar el control",
        resume: "Reanudar",
        dismiss: "Descartar el estado de la ejecución",
        openSteps: "Abre el resumen de pasos",
        now: "Ahora",
        next: "Siguiente",
        steps: "Pasos",
      ...
      controls: {
        ...
        openExternal: "Abrir sitio web en el navegador del dispositivo",
        enterUrl: "IngreseURL",
