  ...
  workspace: {
    ...
    browser: {
      ...
      activity: {
        ...
        step: "Etapa {{step}}",
        stepOf: "Etapa {{step}}/{{total}}",
        checkingPage: "Verificando a página",
        recheckPage: "Verificar a página de novo",
        paused: "Pausado · você está no controle",
        pausing: "Assumindo o controle após esta etapa",
        passed: "Execução aprovada",
        failed: "Execução falhou · {{message}}",
        takeOver: "Assumir o controle",
        resume: "Retomar",
        dismiss: "Dispensar status da execução",
        openSteps: "Abre a visão geral das etapas",
        now: "Agora",
        next: "Próxima",
        steps: "Etapas",
        noSteps: "Nenhuma etapa ainda",
        phase: {
      ...
      controls: {
        ...
        openExternal: "Abrir site no navegador do dispositivo",
