  ...
  workspace: {
    ...
    browser: {
      ...
      activity: {
        ...
        checkingPage: "Vérification de la page",
        recheckPage: "Revérifier la page",
        paused: "En pause · vous avez la main",
        pausing: "Reprise en main après cette étape",
        passed: "Exécution réussie",
        failed: "Exécution échouée · {{message}}",
        takeOver: "Prendre la main",
        resume: "Reprendre",
        dismiss: "Masquer l’état de l’exécution",
        openSteps: "Ouvre l’aperçu des étapes",
        now: "Maintenant",
        next: "Suivant",
        steps: "Étapes",
