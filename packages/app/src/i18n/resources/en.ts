  ...
  workspace: {
    ...
    browser: {
      ...
      activity: {
        ...
        checkingPage: "Checking the page",
        recheckPage: "Re-check page",
        paused: "Paused · you have control",
        pausing: "Taking over after this step",
        passed: "Run passed",
        failed: "Run failed · {{message}}",
        takeOver: "Take over",
        resume: "Resume",
        dismiss: "Dismiss browser run status",
        openSteps: "Opens the step overview",
        now: "Now",
        next: "Next",
        steps: "Steps",
    ...
    tabs: {
      ...
      menu: {
        ...
        copyChatMarkdown: "Copy chat (Markdown)",
        copyChatJson: "Copy chat (JSON)",
      ...
      toasts: {
        ...
        chatCopiedLabel: "Chat transcript",
        copyingChat: "Copying chat...",
        copyChatFailed: "Failed to copy chat",
        chatCopyEmpty: "This chat is empty",
        chatCopyTruncated: "Chat copied without the oldest messages",
    ...
    git: {
      ...
      pr: {
        ...
        set: {
          ...
          attachPlaceholder: "PR numbers, e.g. 1346 or 1346, 1350",
          attachConfirm: "Attach",
          attachNotFound: "No pull request #{{number}} found in this repository.",
          attachNotFoundMany: "No pull requests found in this repository: {{numbers}}.",
          moreInCard: "+{{count}} more",
